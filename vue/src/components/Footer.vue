<template>
  <footer class="w-full bottom-0 bg-gray-900 px-9 py-6 mt-9 z-50">
        <h2 class="text-white text-2xl font-medium">NCD</h2>
        ...
        <p class="text-gray-700 text-right">© 2021 All rights reserverd. Develop by  <a href="#" class="text-gray-400 hover:underline font-medium">Mukul Singla</a></p>
    </footer>
</template>
